...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center" href="/">
            <?= Html::img('@web/images/logo.png', ['alt' => 'ama logo', 'width' => '50', 'height' => '50', 'class' => 'rounded-circle']) ?>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto">
                <?php if (Yii::$app->user->isGuest): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= Url::to(['salon-owner/register']) ?>" data-bs-toggle="modal" data-bs-target="#registerModal">Create Account</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= Url::to(['salon-owner/login']) ?>" class="btn border rounded-pill text-white" style="background-color:#30445AFF">
                    ...
                    <div class="dropdown">
                        <li class="nav-item dropdown user-image">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li>
                                    <?= Html::beginForm(['salon-owner/logout']) ?>
