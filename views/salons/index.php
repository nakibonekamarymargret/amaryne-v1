        ...
        <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
            ...
            <div class="top-saloons">
                <div class="promotions">
                    <?php foreach ($filteredSalons as $salon): ?>
                            ...
                            <a href="<?= Url::to(['salons/view', 'id' => $salon->id]) ?>" class="card-link"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <p class="text-uppercase text-dark fs-6 fw-bolder"><?= Html::encode($salon->name) ?>
                                        </p>
                                        <p class="fw-3 mx-2"><?= Html::encode($salon->formattedTypes) ?></p>
                                    </div>
                                    <p class="mb-2">
                                        <i class="fa-solid fa-location-dot"></i> <span class="mx-1">
                                            <?= Html::encode($salon->address) ?>
                                        </span> 
                                            <i class="bi bi-calendar-check-fill mx-2"></i>
                                            <span>                                                 <?= Html::encode($salon->formattedWorkingDays) ?>
                                            </span>
            ...
            <!-- Second Div: All Salons -->
            <div class="promotions">
                <?php foreach ($allSalons as $salon): ?>
                    <div class="card shadow">
                        <a href="<?= Url::to(['salons/view', 'id' => $salon->id]) ?>" class="card-link shadow"
                            style="text-decoration: none;">
                            <div class="card-body">
                                <img src="<?= Url::to('@web/' . Html::encode($salon->salon_image)) ?>"
                                    alt="<?= Html::encode($salon->name) ?>"
                                ...
                                <p class="mb-2 text-dark">
                                    ...
                                    <i class="text-danger mx-3">
                                        <i class="bi bi-calendar-check-fill mx-2 text-black"></i><?= Html::encode($salon->formattedWorkingDays) ?>
                                    </i>
                                </p>
                            </div>
                        </a>
